      ...
      <div class="table">
        <Table :columns="columns" :data="userList" :loading="loading" border>
          ...
          <template slot="operating" slot-scope="{ row }">
            <el-button plain size="mini" type="success" @click="editUserBtn(row)">编辑</el-button>
            <el-button plain size="mini" type="warning" @click="btnPermission(row)">分配权限</el-button>
            <el-button plain size="mini" type="danger" @click="delUser(row)">删除</el-button>
          </template>
        </Table>
